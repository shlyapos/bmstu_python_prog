...
#  h1,h2,h3 - расстояния от произвольной точки O до сторон треугольника;
...
if AB+BC>CA and BC+CA>AB and AB+CA>BC:  # Свойство существования треугольника
    ...
    if abs(AB**2+BC**2-CA**2)<1e-3:
        print('\nТреугольник является прямоугольным\n')
    elif abs(CA**2+BC**2-AB**2)<1e-3:
        print('\nТреугольник является прямоугольным\n')
    elif abs(AB**2+CA**2-BC**2)<1e-3: 
        print('\nТреугольник является прямоугольным\n')
    else:
