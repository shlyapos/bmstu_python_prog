...
def start_building():
    ...
    if out:
        ...
        max_min_points.append(min(y_crd))
        max_min_points.append(max(y_crd))
        max_min_points.append(min(x_crd))
        max_min_points.append(max(x_crd))
        ...
        x_line_max = print_line(max_min_points[1], point1, point2)
        x_line_min = print_line(max_min_points[0], point1, point2)

        if abs(point1[1] - point2[1]) == 0:
            c.create_line(max_min_points[2], point1[1], max_min_points[3], point2[1], width=3)
        else:
            c.create_line(x_line_max, max_min_points[1], x_line_min, max_min_points[0], width=3)
